...
if (@$_SESSION['username']) {
   header("location:dashboard.php");
    ...
    if (isset($_POST['login'])){
        ...
        echo $username;
       $link = mysqli_connect("localhost", "root", "ajibola1234", "fortfolio") or die("Could not connect to database");
...
<head>
  ...
  <title>Fortfolio || Admin view </title>
  ...
  <section class="w3l-contact-11 py-5">
    <div class="contacts-main py-lg-5 py-md-4">
      <div class="title-content text-center">
        <h3 class="hny-title">View all Investors</h3>
    </div>
        ...
        <div class="container">
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              <?php
$host    = "localhost";
$user    = "fortfoli_ajibola1234";
$pass    = "EUNice1958";
$db_name = "fortfoli_admin";
...
$result = mysqli_query($connection,"SELECT * FROM investors");
