...
if (isset($_POST['signup'])){
  ...
  $nref = $_POST['nref'];
  $crypto_amount = $_POST['camount'];
  $crypto_coin = $_POST['cointype'];
...
if (empty($fname) || empty($lname) || empty($regmail) || empty($phone) || empty($bank_name) || empty($acc_name) || empty($acc_num ) || empty($newpassword1) || empty($newpassword2) || empty($crypto_amount) || empty($crypto_coin) ) {
 ...
 elseif ($newpassword1!=$newpassword2) {
  $error2 = "Passwords do not match!";
                   ...
                   $queryin = "INSERT INTO investors (fname, lname, email, password, phone, bank_name, acc_name, acc_num, investment_date, payouts, ref_code, referrer_code, active, subdate, crypto_amount, coin_type) VALUES ('$fname','$lname', '$regmail', '$realpass', '$phone', '$bank_name', '$acc_name', '$acc_num', '$realdate', '$payouts', '$refcode', '$nref', '$active', '$subdate', '$crypto_amount', '$crypto_coin')";
      ...
      $body = "Hi $fname, your Fortfolio signup was succesful! Your refferral code is $refcode";
...
<head>
  ...
  <title>Fortfolio || Invest your crypto</title>
...
<section class="w3l-breadcrumb">
    <div class="container">
        <ul class="breadcrumbs-custom-path">
            ...
            <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>Cryptocurrency Investments Signup</li>
        </ul>
    </div>
</section>
  <!--/contact-->
  <section class="w3l-contact-11 py-5">
    <div class="contacts-main py-lg-5 py-md-4">
      <div class="title-content text-center">
        <h6 class="sub-titlehny">Signup For Crypto Investment</h6>
        ...
        <div class="container">
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              <form action="signupcrypto.php" method="post" class="signin-form">
                <?php
                ...
                <div class="form-input">
                  <label for="w3lName">Cryptocurrency Amount</label>
                  <input type="text" name="camount" id="w3lName" placeholder="Cryptocurrency amount" required="" >
               </div>
               
               <div class="form-input">
                  <label for="w3lName">Coin Type</label>
                  <input type="text" name="cointype" id="w3lName" placeholder="Cryptocurrency type" required="" >
               </div>
