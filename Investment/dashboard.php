...
$link = mysqli_connect("localhost", "fortfoli_ajibola1234", "EUNice1958", "fortfoli_admin") or die("could not connect to database");
            $query = "SELECT id, fname, lname, bank_name, acc_name, acc_num, ref_code, amount, investment_date, payouts, active, package, subdate, withdraw, exp_date, interest, crypto_amount, coin_type FROM investors WHERE email = '$loggedin' AND password = '$pword'";
            ...
            if ($result) {
                if (mysqli_num_rows($result) ==1) {
                    while ($output = mysqli_fetch_assoc($result)) {
                        ...
                        $refcode = $output['ref_code'];
                        $amount = $output['amount'];
                        $active = $output['active'];
                        $payouts = $output['payouts'];
                        $bank = $output['bank_name'];
                        $withdraw  = $output['withdraw'];
                        $expdate = $output['exp_date'];
                        $interest = $output['interest'];
                        $cointype = $output['coin_type'];
                        $coinamount = $output['crypto_amount'];
                        //echo $package;
                        //echo $firstname;
                    }
                }
                $queryb = "SELECT id FROM investors WHERE referrer_code = '$refcode'";
                if($resultb = mysqli_query($link, $queryb)){
                 $countref = mysqli_num_rows($resultb);
                }
            }
?>
<!doctype html>
...
<head>
  ...
  <title>Fortfolio Trade Investment || dashboard </title>
    ...
    <div class="container py-md-5 py-3">
      <div class="row bottom-ab-grids align-items-center">
        ...
        <div class="col-lg-6 bottom-ab-left">
          <h6 class="sub-titlehny" >Hi <?php echo @$firstname.' '.@$lastname;?>, Good day!</h6>
          <h3 class="hny-title">How may we be of help today?</p>
        </div>
          <a href="confirmwithdrawal.php"><button type="submit" class="btn btn-style btn-primary" name="withdraw" class="out"> REQUEST A WITHDRAWAL </button></a>
        <form action = "dashboard.php" method="post" class="out"> 
            <div class="form-submit text-right">
                   <button type="submit" class="btn btn-style btn-primary" name="logout">LOGOUT</button>
            </div>
  </form>
        <div class="col-lg-6 bottom-ab-right mt-lg-0 mt-3 pl-lg-4">
          <p span style="color:green"><b>Notifications!</b></p>
          <p class="mt-3">Great new offers coming soon! Watch out.</p>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mt-5">
          <div class="grid-block">
            <a href="" class="d-block p-lg-4 p-3">
              ...
              <h4 class="my-3" span style="color: green">Current package: <?php echo @$package;?></h4>
              <h4 class="my-3" span style="color: green">My referral code: <?php echo @$refcode;?></h4>
              <h4 class="my-3" span style="color: green">Number of referrals: <?php echo @$countref;?></h4>
        ...
        <div class="col-lg-4 col-md-6 mt-5">
          <div class="grid-block">
            <a href="" class="d-block p-lg-4 p-3">
              ...
              <h4 class="my-3" span style="color: green">Amount invested: NGN <?php echo @$amount;?></h4>
              <h4 class="my-3" span style="color: green">Crypto Amount invested:  <?php echo @$coinamount;?></h4>
              <h4 class="my-3" span style="color: green">Crypto Coin Type: <?php echo @$cointype;?></h4>
              <h4 span style="color: green">Investment date: <?php echo @$date;?></h4><br>
              <h4 span style="color: green">Expiry date: <?php echo $expdate; ?></h4>
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-5">
          <div class="grid-block">
            <a href="" class="d-block p-lg-4 p-3">
              ...
              <h4 class="my-3" span style="color: green">Bank name: <?php echo @$bank;?></h4>
              <h4 span style="color: green">Account name: <?php echo @$accname;?></h4>
              <h4 span style="color: green">Account number: <?php echo @$accnum;?></h4>
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-5">
          <div class="grid-block">
            <a href="" class="d-block p-lg-4 p-3">
              ...
              <h4 class="my-3" span style="color: green">Payouts: <?php echo @$payouts;?> </h4>
              <h4 class="my-3" span style="color: green">Withdrawal status: <?php echo @$withdraw;?> </h4>
              <h4 class="my-3" span style="color: green">Interest: NGN <?php echo @$interest;?> </h4>
              <h4 class="my-3" span style="color: green">Account status: <?php echo @$active;?> </h4>
              <p class=""></p>
            </a>
          </div>
        </div>
