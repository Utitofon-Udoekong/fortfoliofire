...
if (isset($_POST['withdraw'])) {
  ...
  $link = mysqli_connect("localhost", "fortfoli_ajibola1234", "EUNice1958", "fortfoli_admin");
    ...
    $querywith = "UPDATE `investors` SET withdraw = '$req' WHERE `email` = '$loggedin'";
 // $success = mysqli_query($link,$querywith);
  if ($success = mysqli_query($link, $querywith)) {
...
<head>
  ...
  <title>Fortfolio Trade Investment || Confirm withdrawal request </title>
...
<body>
  ...
  <section class="w3l-grids-3 py-5" id="about">
    <div class="container py-md-5 py-3">
      <div class="row bottom-ab-grids align-items-center">
        ...
        <div class="col-lg-6 bottom-ab-left">
          ...
          <h3 class="hny-title">Are you sure you would like to request a withdrawal?</p>
        </div>
         
        <form action = "confirmwithdrawal.php" method="post" class="out"> 
            <div class="form-submit text-right">
                  <button type="submit" class="btn btn-style btn-primary" name="withdraw">YES</button>
    ...
    <br><a href="dashboard.php"> <button type="submit" class="btn btn-style btn-primary" id="back" > RETURN TO DASHBOARD </button></a>
  </section>
  <!--//grids-->
  <!--/w3l-faq-block-->
  <!--//w3l-faq-block-->
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="bottom-copies">
        <p class="copy-footer-29 text-center">© 2020 Fortfolio. All rights reserved.</p>
      </div>
    </div>
