...
class _$DashboardStateTearOff {
  ...
  _DashboardState call({required List<dynamic> news, required bool loading}) {
...
abstract class $DashboardStateCopyWith<$Res> {
  ...
  $Res call({List<dynamic> news, bool loading});
}
...
class _$_DashboardState extends _DashboardState {
  const _$_DashboardState({required this.news, required this.loading})
      : super._();
  ...
  @override
  String toString() {
    return 'DashboardState(news: $news, loading: $loading)';
  }
...
abstract class _DashboardState extends DashboardState {
  const factory _DashboardState(
      {required List<dynamic> news, required bool loading}) = _$_DashboardState;
