...
class _$ValueFailureTearOff {
  ...
  ShortName<T> shortName<T>({required String failedValue}) {
    return ShortName<T>(
      failedValue: failedValue,
    );
  }

  InvalidPhone<T> invalidPhone<T>({required String failedValue}) {
...
abstract class ShortName<T> implements ValueFailure<T> {
  const factory ShortName({required String failedValue}) = _$ShortName<T>;
...
abstract class InvalidPhone<T> implements ValueFailure<T> {
  const factory InvalidPhone({required String failedValue}) = _$InvalidPhone<T>;
