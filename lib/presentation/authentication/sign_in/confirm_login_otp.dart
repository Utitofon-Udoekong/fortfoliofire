            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'We sent an OTP to the number ${context.read<SignInFormPhoneCubit>().state.phoneNumber}',
                    style: titleText,
                  ),
                  const SizedBox(
                    height: 20,
                  ...
                  OTPTextField(
                    ...
                    onChanged: (value) => context.read<SignInFormPhoneCubit>().smsCodeChanged(smsCode: value),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
                  CustomAuthFilledButton(
                    text:
                        context.read<SignInFormPhoneCubit>().state.isSubmitting
                            ? 'VERIFYING'
                            : 'VERIFY',
                    onTap: () => context.read<SignInFormPhoneCubit>().verifySmsCode(),
                    disabled:
                        context.read<SignInFormPhoneCubit>().state.isSubmitting,
                  ),
                  const SizedBox(
