    ...
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          child: Obx(() => Form(key: _formKey, child: Padding(padding: kDefaultPadding,
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  InkWell(onTap: () => Get.toNamed('/login'), child: const Icon(Icons.close),),
                  InkWell(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () => Get.to(SignUpPhoneView()), 
              ...
              TextFormField(
                ...
                onChanged: controller.updateSignupEmailform,
              ),
              const SizedBox(
                height: 20,
              ),
              ...
              onTap: () => controller.submitEnabled.value ? controller.signup() : null, disabled: !controller.submitEnabled.value,),
            ],
          ),)),)
        ),
      )
