...
class AppRouter extends _i60.RootStackRouter {
  ...
  List<_i60.RouteConfig> get routes => [
        ...
        _i60.RouteConfig(NotificationEngineRoute.name,
            path: '/notification-engine'),
        _i60.RouteConfig(ProfilePageRoute.name, path: 'profilePage'),
        ...
        _i60.RouteConfig(ChangePasswordRoute.name, path: 'changepassword'),
        _i60.RouteConfig(AddBankRoute.name, path: 'addBank'),
        _i60.RouteConfig(VerifyBankRoute.name, path: 'verifyBank'),
        _i60.RouteConfig(AddCryptoWalletRoute.name, path: 'addCryptoWallet'),
        _i60.RouteConfig(VerifyCryptoWalletRoute.name,
            path: 'verifyCryptoWallet'),
        _i60.RouteConfig(BankAddressRoute.name, path: 'bankPage'),
        _i60.RouteConfig(CryptoWalletRoute.name, path: 'cryptoWalletPage'),
        _i60.RouteConfig(PaymentMethodRoute.name, path: 'paymentmethod'),
        _i60.RouteConfig(FAQPageRoute.name, path: 'faq'),
        _i60.RouteConfig(SupportPageRoute.name, path: 'support'),
        _i60.RouteConfig(TACPageRoute.name, path: 'tac'),
        _i60.RouteConfig(UploadDocumentImageRoute.name,
            path: 'uploadDocumentImage'),
        _i60.RouteConfig(UploadPageRoute.name, path: 'uploadPage'),
        _i60.RouteConfig(UtilityPageRoute.name, path: 'utilityPage'),
        _i60.RouteConfig(UploadUtilityDocRoute.name,
            path: 'uploadUtilityDocument'),
        _i60.RouteConfig(VerificationPageRoute.name, path: 'verificationPage'),
        ...
        _i60.RouteConfig(BankInvestmentPageRoute.name, path: 'bankInvestment'),
        _i60.RouteConfig(NairaAccountRoute.name, path: 'naira'),
        _i60.RouteConfig(DomiciliaryAccountRoute.name, path: 'dollar'),
        _i60.RouteConfig(CryptoInvestmentPageRoute.name,
            path: 'cryptoInvestment'),
        _i60.RouteConfig(FortCryptoRoute.name, path: 'fortcrypto'),
        _i60.RouteConfig(FortCryptoInvestmentRoute.name,
            path: 'fortcryptoinvest'),
        _i60.RouteConfig(FortDollarRoute.name, path: 'fortdollar'),
        _i60.RouteConfig(FortDollarInvestmentRoute.name,
            path: 'fortdollarinvest'),
        _i60.RouteConfig(FortShieldRoute.name, path: 'fortshield'),
        _i60.RouteConfig(FortShieldInvestmentRoute.name,
            path: 'fortshieldinvest'),
        _i60.RouteConfig(WalletOverviewRoute.name, path: 'walletOverview'),
        _i60.RouteConfig(WalletOverviewEngineRoute.name,
        ...
        _i60.RouteConfig(BankWithdrawalRoute.name, path: 'bankwithdrawal'),
        _i60.RouteConfig(CryptoWithdrawalRoute.name, path: 'cryptowithdrawal'),
        ...
        _i60.RouteConfig(WithdrawalPageRoute.name, path: 'withdrawPage'),
        _i60.RouteConfig(WithdrawalSuccessRoute.name,
            path: 'withdrawalSuccess'),
        _i60.RouteConfig(NoInternetPageRoute.name, path: 'noInternet'),
...
class NotificationEngineRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i21.BankAddress]
class BankAddressRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.CryptoWallet]
class CryptoWalletRoute extends _i60.PageRouteInfo<void> {
...
class WalletOverviewEngineRoute extends _i60.PageRouteInfo<void> {
