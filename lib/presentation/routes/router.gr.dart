...
import '../home/dashboard/dashboard.dart' as _i57;
...
import '../home/dashboard/screens/verification/verification_success.dart'
    as _i32;
import '../home/home_page.dart' as _i56;
import '../home/investment/calculator/investment_calculator.dart' as _i14;
import '../home/investment/investment.dart' as _i58;
...
import '../home/investment/success.dart' as _i54;
...
import '../home/wallet/wallet.dart' as _i59;
...
import '../network/no_connection.dart' as _i55;
...
class AppRouter extends _i60.RootStackRouter {
  ...
  final Map<String, _i60.PageFactory> pagesMap = {
    SplashScreenRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
    ...
    BankAddressPageRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i21.BankAddressPage());
    },
    CryptoWalletPageRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i22.CryptoWalletPage());
    },
    ...
    InvestmentSuccessRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i54.InvestmentSuccess());
    },
    NoInternetPageRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i55.NoInternetPage());
    },
    HomePageRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i56.HomePage());
    },
    DashboardRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i57.Dashboard());
    },
    InvestmentPageRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i58.InvestmentPage());
    },
    WalletRoute.name: (routeData) {
      return _i60.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i59.Wallet());
    }
  };

  @override
  List<_i60.RouteConfig> get routes => [
        _i60.RouteConfig(SplashScreenRoute.name, path: '/'),
        _i60.RouteConfig(OnboardingScreenRoute.name,
            path: '/onboarding-screen'),
        _i60.RouteConfig(SignInFormEmailRoute.name,
            path: '/sign-in-form-email'),
        _i60.RouteConfig(SignInFormPhoneRoute.name,
            path: '/sign-in-form-phone'),
        _i60.RouteConfig(SignUpFormPhoneRoute.name,
            path: '/sign-up-form-phone'),
        _i60.RouteConfig(ConfirmLoginWithOTPRoute.name,
            path: '/confirm-login-with-ot-p'),
        _i60.RouteConfig(ConfirmSignupWithOTPRoute.name,
            path: '/confirm-signup-with-ot-p'),
        _i60.RouteConfig(ConfirmPhoneUpdateRoute.name,
            path: '/confirm-phone-update'),
        _i60.RouteConfig(SignUpFormRoute.name, path: '/sign-up-form'),
        _i60.RouteConfig(ResetPasswordRoute.name, path: '/reset-password'),
        _i60.RouteConfig(NotificationsPageRoute.name,
            path: '/notifications-page'),
        _i60.RouteConfig(ProfilePageRoute.name, path: '/profile-page'),
        _i60.RouteConfig(DashboardTransactionsRoute.name,
            path: '/dashboard-transactions'),
        _i60.RouteConfig(CalculatorRoute.name, path: '/Calculator'),
        _i60.RouteConfig(SecurityRoute.name, path: '/Security'),
        _i60.RouteConfig(ChangePasswordRoute.name, path: '/change-password'),
        _i60.RouteConfig(AddBankRoute.name, path: '/add-bank'),
        _i60.RouteConfig(VerifyBankRoute.name, path: '/verify-bank'),
        _i60.RouteConfig(AddCryptoWalletRoute.name, path: '/add-crypto-wallet'),
        _i60.RouteConfig(VerifyCryptoWalletRoute.name,
            path: '/verify-crypto-wallet'),
        _i60.RouteConfig(BankAddressPageRoute.name, path: '/bank-address-page'),
        _i60.RouteConfig(CryptoWalletPageRoute.name,
            path: '/crypto-wallet-page'),
        _i60.RouteConfig(PaymentMethodRoute.name, path: '/payment-method'),
        _i60.RouteConfig(FAQPageRoute.name, path: '/f-aq-page'),
        _i60.RouteConfig(SupportPageRoute.name, path: '/support-page'),
        _i60.RouteConfig(TACPageRoute.name, path: '/t-ac-page'),
        _i60.RouteConfig(UploadDocumentImageRoute.name,
            path: '/upload-document-image'),
        _i60.RouteConfig(UploadPageRoute.name, path: '/upload-page'),
        _i60.RouteConfig(UtilityPageRoute.name, path: '/utility-page'),
        _i60.RouteConfig(UploadUtilityDocRoute.name,
            path: '/upload-utility-doc'),
        _i60.RouteConfig(VerificationPageRoute.name,
            path: '/verification-page'),
        _i60.RouteConfig(VerificationSuccessRoute.name,
            path: '/verification-success'),
        _i60.RouteConfig(SelectInvestmentMethodRoute.name,
            path: '/select-investment-method'),
        _i60.RouteConfig(BankInvestmentPageRoute.name,
            path: '/bank-investment-page'),
        _i60.RouteConfig(NairaAccountRoute.name, path: '/naira-account'),
        _i60.RouteConfig(DomiciliaryAccountRoute.name,
            path: '/domiciliary-account'),
        _i60.RouteConfig(CryptoInvestmentPageRoute.name,
            path: '/crypto-investment-page'),
        _i60.RouteConfig(FortCryptoRoute.name, path: '/fort-crypto'),
        _i60.RouteConfig(FortCryptoInvestmentRoute.name,
            path: '/fort-crypto-investment'),
        _i60.RouteConfig(FortDollarRoute.name, path: '/fort-dollar'),
        _i60.RouteConfig(FortDollarInvestmentRoute.name,
            path: '/fort-dollar-investment'),
        _i60.RouteConfig(FortShieldRoute.name, path: '/fort-shield'),
        _i60.RouteConfig(FortShieldInvestmentRoute.name,
            path: '/fort-shield-investment'),
        _i60.RouteConfig(WalletOverviewRoute.name, path: '/wallet-overview'),
        _i60.RouteConfig(WalletTransactionsRoute.name,
            path: '/wallet-transactions'),
        _i60.RouteConfig(SelectWithdrawalMethodRoute.name,
            path: '/select-withdrawal-method'),
        _i60.RouteConfig(BankWithdrawalRoute.name, path: '/bank-withdrawal'),
        _i60.RouteConfig(CryptoWithdrawalRoute.name,
            path: '/crypto-withdrawal'),
        _i60.RouteConfig(FortDollarInvestmentInfoRoute.name,
            path: '/fort-dollar-investment-info'),
        _i60.RouteConfig(FortShieldInvestmentInfoRoute.name,
            path: '/fort-shield-investment-info'),
        _i60.RouteConfig(FortCryptoInvestmentInfoRoute.name,
            path: '/fort-crypto-investment-info'),
        _i60.RouteConfig(WithdrawalPageRoute.name, path: '/withdrawal-page'),
        _i60.RouteConfig(WithdrawalSuccessRoute.name,
            path: '/withdrawal-success'),
        _i60.RouteConfig(InvestmentSuccessRoute.name,
            path: '/investment-success'),
        _i60.RouteConfig(NoInternetPageRoute.name, path: '/no-internet-page'),
        _i60.RouteConfig(HomePageRoute.name, path: '/home', children: [
          _i60.RouteConfig(DashboardRoute.name,
              path: 'dashboard', parent: HomePageRoute.name),
          _i60.RouteConfig(InvestmentPageRoute.name,
              path: 'investments', parent: HomePageRoute.name),
          _i60.RouteConfig(WalletRoute.name,
...
/// generated route for
/// [_i1.SplashScreen]
class SplashScreenRoute extends _i60.PageRouteInfo<void> {
...
class OnboardingScreenRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.SignInFormEmail]
class SignInFormEmailRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.SignInFormPhone]
class SignInFormPhoneRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.SignUpFormPhone]
class SignUpFormPhoneRoute extends _i60.PageRouteInfo<void> {
...
class ConfirmLoginWithOTPRoute extends _i60.PageRouteInfo<void> {
...
class ConfirmSignupWithOTPRoute extends _i60.PageRouteInfo<void> {
...
class ConfirmPhoneUpdateRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.SignUpForm]
class SignUpFormRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.ResetPassword]
class ResetPasswordRoute extends _i60.PageRouteInfo<void> {
...
class NotificationsPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.ProfilePage]
class ProfilePageRoute extends _i60.PageRouteInfo<void> {
...
class DashboardTransactionsRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.Calculator]
class CalculatorRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i15.Security]
class SecurityRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.ChangePassword]
class ChangePasswordRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i17.AddBank]
class AddBankRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i18.VerifyBank]
class VerifyBankRoute extends _i60.PageRouteInfo<void> {
...
class AddCryptoWalletRoute extends _i60.PageRouteInfo<void> {
...
class VerifyCryptoWalletRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i21.BankAddressPage]
class BankAddressPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.CryptoWalletPage]
class CryptoWalletPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i23.PaymentMethod]
class PaymentMethodRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.FAQPage]
class FAQPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i25.SupportPage]
class SupportPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i26.TACPage]
class TACPageRoute extends _i60.PageRouteInfo<void> {
...
class UploadDocumentImageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i28.UploadPage]
class UploadPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i29.UtilityPage]
class UtilityPageRoute extends _i60.PageRouteInfo<void> {
...
class UploadUtilityDocRoute extends _i60.PageRouteInfo<void> {
...
class VerificationPageRoute extends _i60.PageRouteInfo<void> {
...
class VerificationSuccessRoute extends _i60.PageRouteInfo<void> {
...
class SelectInvestmentMethodRoute extends _i60.PageRouteInfo<void> {
...
class BankInvestmentPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i35.NairaAccount]
class NairaAccountRoute extends _i60.PageRouteInfo<void> {
...
class DomiciliaryAccountRoute extends _i60.PageRouteInfo<void> {
...
class CryptoInvestmentPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i38.FortCrypto]
class FortCryptoRoute extends _i60.PageRouteInfo<void> {
...
class FortCryptoInvestmentRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i40.FortDollar]
class FortDollarRoute extends _i60.PageRouteInfo<void> {
...
class FortDollarInvestmentRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i42.FortShield]
class FortShieldRoute extends _i60.PageRouteInfo<void> {
...
class FortShieldInvestmentRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i44.WalletOverview]
class WalletOverviewRoute extends _i60.PageRouteInfo<void> {
...
class WalletTransactionsRoute extends _i60.PageRouteInfo<void> {
...
class SelectWithdrawalMethodRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i47.BankWithdrawal]
class BankWithdrawalRoute extends _i60.PageRouteInfo<void> {
...
class CryptoWithdrawalRoute extends _i60.PageRouteInfo<void> {
...
class FortDollarInvestmentInfoRoute extends _i60.PageRouteInfo<void> {
...
class FortShieldInvestmentInfoRoute extends _i60.PageRouteInfo<void> {
...
class FortCryptoInvestmentInfoRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i52.WithdrawalPage]
class WithdrawalPageRoute extends _i60.PageRouteInfo<void> {
...
class WithdrawalSuccessRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i54.InvestmentSuccess]
class InvestmentSuccessRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i55.NoInternetPage]
class NoInternetPageRoute extends _i60.PageRouteInfo<void> {
...
/// generated route for
/// [_i58.InvestmentPage]
class InvestmentPageRoute extends _i60.PageRouteInfo<void> {
