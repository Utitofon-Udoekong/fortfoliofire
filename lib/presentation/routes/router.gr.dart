...
import '../home/dashboard/dashboard.dart' as _i55;
...
import '../home/dashboard/screens/verification/verification_success.dart'
    as _i31;
import '../home/home_page.dart' as _i54;
import '../home/investment/calculator/investment_calculator.dart' as _i13;
import '../home/investment/investment.dart' as _i56;
...
import '../home/wallet/wallet.dart' as _i57;
...
class AppRouter extends _i58.RootStackRouter {
  ...
  final Map<String, _i58.PageFactory> pagesMap = {
    ...
    DashboardRoute.name: (routeData) {
      return _i58.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i55.Dashboard());
    },
    InvestmentPageRoute.name: (routeData) {
      return _i58.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i56.InvestmentPage());
    },
    WalletRoute.name: (routeData) {
      return _i58.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i57.Wallet());
    }
  };

  @override
  List<_i58.RouteConfig> get routes => [
        _i58.RouteConfig(SplashScreenRoute.name, path: '/'),
        _i58.RouteConfig(OnboardingScreenRoute.name,
            path: '/onboarding-screen'),
        _i58.RouteConfig(SignInFormEmailRoute.name,
            path: '/sign-in-form-email'),
        _i58.RouteConfig(SignInFormPhoneRoute.name,
            path: '/sign-in-form-phone'),
        _i58.RouteConfig(SignUpFormPhoneRoute.name,
            path: '/sign-up-form-phone'),
        _i58.RouteConfig(ConfirmLoginWithOTPRoute.name,
            path: '/confirm-login-with-ot-p'),
        _i58.RouteConfig(ConfirmSignupWithOTPRoute.name,
            path: '/confirm-signup-with-ot-p'),
        _i58.RouteConfig(SignUpFormRoute.name, path: '/sign-up-form'),
        _i58.RouteConfig(ResetPasswordRoute.name, path: '/reset-password'),
        _i58.RouteConfig(NotificationsPageRoute.name,
            path: 'notificationsPage'),
        _i58.RouteConfig(ProfilePageRoute.name, path: 'profilePage'),
        _i58.RouteConfig(DashboardTransactionsRoute.name,
            path: 'dashboardTransactions'),
        _i58.RouteConfig(CalculatorRoute.name, path: 'calculator'),
        _i58.RouteConfig(SecurityRoute.name, path: 'security'),
        _i58.RouteConfig(ChangePasswordRoute.name, path: 'changepassword'),
        _i58.RouteConfig(AddBankRoute.name, path: 'addBank'),
        _i58.RouteConfig(VerifyBankRoute.name, path: 'verifyBank'),
        _i58.RouteConfig(AddCryptoWalletRoute.name, path: 'addCryptoWallet'),
        _i58.RouteConfig(VerifyCryptoWalletRoute.name,
            path: 'verifyCryptoWallet'),
        _i58.RouteConfig(BankAddressRoute.name, path: 'bankPage'),
        _i58.RouteConfig(CryptoWalletRoute.name, path: 'cryptoWalletPage'),
        _i58.RouteConfig(PaymentMethodRoute.name, path: 'paymentmethod'),
        _i58.RouteConfig(FAQPageRoute.name, path: 'faq'),
        _i58.RouteConfig(SupportPageRoute.name, path: 'support'),
        _i58.RouteConfig(TACPageRoute.name, path: 'tac'),
        _i58.RouteConfig(UploadDocumentImageRoute.name,
            path: 'uploadDocumentImage'),
        _i58.RouteConfig(UploadPageRoute.name, path: 'uploadPage'),
        _i58.RouteConfig(UtilityPageRoute.name, path: 'utilityPage'),
        _i58.RouteConfig(UploadUtilityDocRoute.name,
            path: 'uploadUtilityDocument'),
        _i58.RouteConfig(VerificationPageRoute.name, path: 'verificationPage'),
        _i58.RouteConfig(VerificationSuccessRoute.name,
            path: 'uploadVerificationSuccess'),
        _i58.RouteConfig(SelectInvestmentMethodRoute.name,
            path: 'selectInvestmentMethod'),
        _i58.RouteConfig(BankInvestmentPageRoute.name, path: 'bankInvestment'),
        _i58.RouteConfig(NairaAccountRoute.name, path: 'naira'),
        _i58.RouteConfig(DomiciliaryAccountRoute.name, path: 'dollar'),
        _i58.RouteConfig(CryptoInvestmentPageRoute.name,
            path: 'cryptoInvestment'),
        _i58.RouteConfig(FortCryptoRoute.name, path: 'fortcrypto'),
        _i58.RouteConfig(FortCryptoInvestmentRoute.name,
            path: 'fortcryptoinvest'),
        _i58.RouteConfig(FortDollarRoute.name, path: 'fortdollar'),
        _i58.RouteConfig(FortDollarInvestmentRoute.name,
            path: 'fortdollarinvest'),
        _i58.RouteConfig(FortShieldRoute.name, path: 'fortshield'),
        _i58.RouteConfig(FortShieldInvestmentRoute.name,
            path: 'fortshieldinvest'),
        _i58.RouteConfig(WalletOverviewRoute.name, path: 'walletOverview'),
        _i58.RouteConfig(WalletOverviewEngineRoute.name,
            path: 'walletOverviewEngine'),
        _i58.RouteConfig(WalletTransactionsRoute.name,
            path: 'walletTransactions'),
        _i58.RouteConfig(SelectWithdrawalMethodRoute.name,
            path: 'selectWithdrawalMethod'),
        _i58.RouteConfig(BankWithdrawalRoute.name, path: 'bankwithdrawal'),
        _i58.RouteConfig(CryptoWithdrawalRoute.name, path: 'cryptowithdrawal'),
        _i58.RouteConfig(FortDollarInvestmentInfoRoute.name,
            path: 'fortdollarinvestinfo'),
        _i58.RouteConfig(FortShieldInvestmentInfoRoute.name,
            path: 'fortshieldinvestinfo'),
        _i58.RouteConfig(FortCryptoInvestmentInfoRoute.name,
            path: 'fortcryptoinvestinfo'),
        _i58.RouteConfig(WithdrawalPageRoute.name, path: 'withdrawPage'),
        _i58.RouteConfig(WithdrawalSuccessRoute.name,
            path: 'withdrawalSuccess'),
        _i58.RouteConfig(HomePageRoute.name, path: '/home', children: [
          _i58.RouteConfig(DashboardRoute.name,
              path: 'dashboard', parent: HomePageRoute.name),
          _i58.RouteConfig(InvestmentPageRoute.name,
              path: 'investments', parent: HomePageRoute.name),
          _i58.RouteConfig(WalletRoute.name,
...
/// generated route for
/// [_i1.SplashScreen]
class SplashScreenRoute extends _i58.PageRouteInfo<void> {
...
class OnboardingScreenRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.SignInFormEmail]
class SignInFormEmailRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.SignInFormPhone]
class SignInFormPhoneRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.SignUpFormPhone]
class SignUpFormPhoneRoute extends _i58.PageRouteInfo<void> {
...
class ConfirmLoginWithOTPRoute extends _i58.PageRouteInfo<void> {
...
class ConfirmSignupWithOTPRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.SignUpForm]
class SignUpFormRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.ResetPassword]
class ResetPasswordRoute extends _i58.PageRouteInfo<void> {
...
class NotificationsPageRoute extends _i58.PageRouteInfo<void> {
...
class DashboardTransactionsRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.Calculator]
class CalculatorRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.Security]
class SecurityRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.AddBank]
class AddBankRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i17.VerifyBank]
class VerifyBankRoute extends _i58.PageRouteInfo<void> {
...
class AddCryptoWalletRoute extends _i58.PageRouteInfo<void> {
...
class VerifyCryptoWalletRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.BankAddress]
class BankAddressRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i21.CryptoWallet]
class CryptoWalletRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.PaymentMethod]
class PaymentMethodRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i23.FAQPage]
class FAQPageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.SupportPage]
class SupportPageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i25.TACPage]
class TACPageRoute extends _i58.PageRouteInfo<void> {
...
class UploadDocumentImageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i27.UploadPage]
class UploadPageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i28.UtilityPage]
class UtilityPageRoute extends _i58.PageRouteInfo<void> {
...
class UploadUtilityDocRoute extends _i58.PageRouteInfo<void> {
...
class VerificationPageRoute extends _i58.PageRouteInfo<void> {
...
class VerificationSuccessRoute extends _i58.PageRouteInfo<void> {
...
class SelectInvestmentMethodRoute extends _i58.PageRouteInfo<void> {
...
class BankInvestmentPageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i34.NairaAccount]
class NairaAccountRoute extends _i58.PageRouteInfo<void> {
...
class DomiciliaryAccountRoute extends _i58.PageRouteInfo<void> {
...
class CryptoInvestmentPageRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i37.FortCrypto]
class FortCryptoRoute extends _i58.PageRouteInfo<void> {
...
class FortCryptoInvestmentRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i39.FortDollar]
class FortDollarRoute extends _i58.PageRouteInfo<void> {
...
class FortDollarInvestmentRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i41.FortShield]
class FortShieldRoute extends _i58.PageRouteInfo<void> {
...
class FortShieldInvestmentRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i43.WalletOverview]
class WalletOverviewRoute extends _i58.PageRouteInfo<void> {
...
class WalletOverviewEngineRoute extends _i58.PageRouteInfo<void> {
...
class WalletTransactionsRoute extends _i58.PageRouteInfo<void> {
...
class SelectWithdrawalMethodRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i47.BankWithdrawal]
class BankWithdrawalRoute extends _i58.PageRouteInfo<void> {
...
class CryptoWithdrawalRoute extends _i58.PageRouteInfo<void> {
...
class FortDollarInvestmentInfoRoute extends _i58.PageRouteInfo<void> {
...
class FortShieldInvestmentInfoRoute extends _i58.PageRouteInfo<void> {
...
class FortCryptoInvestmentInfoRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i52.WithdrawalPage]
class WithdrawalPageRoute extends _i58.PageRouteInfo<void> {
...
class WithdrawalSuccessRoute extends _i58.PageRouteInfo<void> {
...
/// generated route for
/// [_i56.InvestmentPage]
class InvestmentPageRoute extends _i58.PageRouteInfo<void> {
