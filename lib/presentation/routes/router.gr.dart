...
class AppRouter extends _i61.RootStackRouter {
  ...
  List<_i61.RouteConfig> get routes => [
        ...
        _i61.RouteConfig(ProfileEngineRoute.name, path: '/profile-engine'),
...
/// generated route for
/// [_i13.ProfileEngine]
class ProfileEngineRoute extends _i61.PageRouteInfo<void> {
  const ProfileEngineRoute()
      : super(ProfileEngineRoute.name, path: '/profile-engine');

  static const String name = 'ProfileEngineRoute';
}
