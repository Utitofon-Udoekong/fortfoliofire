      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const CustomIconTrailingButton(icon: 'faq', title: 'FAQ', page: faq),
            const SizedBox(
              height: 10,
            ),
            const CustomIconTrailingButton(icon: 'mail', title: 'Send an email', page: faq),
            const SizedBox(
              height: 10,
            ),
            const CustomIconTrailingButton(icon: 'livechat', title: 'Live Chat', page: faq),
            const SizedBox(
              height: 60,
            ),
            Row(
