...
abstract class $BankAddressStateCopyWith<$Res> {
  ...
  $Res call(
      {String bankName, String accountNumber, bool isLoading, String response});
}
...
class _$_BankAddressState extends _BankAddressState {
  ...
  @override
  String toString() {
    return 'BankAddressState(bankName: $bankName, accountNumber: $accountNumber, isLoading: $isLoading, response: $response)';
  }
