      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const CustomIconTrailingButton(icon: 'idcard', title: 'National ID Card', page: verificationDoc ),
            const SizedBox(
              height: 20,
            ),
            const CustomIconTrailingButton(icon: 'passport', title: 'International Passport', page: verificationDoc ),
            const SizedBox(
              height: 20,
            ),
            const CustomIconTrailingButton(icon: 'license', title: 'Drivers License', page: verificationDoc ),
          ],
        ),
      ),
    ),
