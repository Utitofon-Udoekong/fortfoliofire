                              ...
                              children: <Widget>[
                                ...
                                Row(children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'Subject = ${const Text('N', style: TextStyle(decoration: TextDecoration.lineThrough))}560',
                                    ...
                                    children: <Widget>[
                                      ...
                                      Flex(
                                        ...
                                        children: <Widget>[
                                          ...
                                          IconButton(
                                              onPressed: () => Clipboard.setData(const ClipboardData(text: "0627767970")).then((_) {
                                ...
                                CustomFilledButton(text: 'I HAVE PAID', onTap: () => context.read<InvestmentCubit>().iHavePaid())
                              ],
                            );
              },
            ),
