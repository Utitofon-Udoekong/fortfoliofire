...
import 'application/auth/reset_password_form/reset_password_bloc.dart' as _i25;
...
import 'infrastructure/auth/firebase_auth_facade.dart' as _i24;
...
import 'presentation/home/investment/type/cubit/exchange_type_cubit.dart'
    as _i13;
import 'presentation/home/wallet/cubit/wallet_cubit.dart' as _i22;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i22.WalletCubit>(
      () => _i22.WalletCubit(get<_i5.FireStoreMethods>()));
  ...
  gh.factory<_i25.ResetPasswordBloc>(
      () => _i25.ResetPasswordBloc(get<_i23.IAuthFacade>()));
  return get;
}
