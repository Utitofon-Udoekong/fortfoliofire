...
import 'application/auth/reset_password_form/reset_password_cubit.dart' as _i15;
...
import 'application/auth/sign_in_form/phone/sign_in_form_phone_cubit.dart'
    as _i18;
import 'application/auth/sign_up_form/email/sign_up_form_cubit.dart' as _i19;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.ResetPasswordCubit>(
      () => _i15.ResetPasswordCubit(get<_i7.IAuthFacade>()));
  gh.factory<_i16.SecurityCubit>(
      () => _i16.SecurityCubit(get<_i7.IAuthFacade>()));
  gh.factory<_i17.SignInFormEmailCubit>(() =>
      _i17.SignInFormEmailCubit(get<_i7.IAuthFacade>(), get<_i3.AuthCubit>()));
  gh.factory<_i18.SignInFormPhoneCubit>(
      () => _i18.SignInFormPhoneCubit(get<_i3.AuthCubit>()));
  gh.factory<_i19.SignUpFormCubit>(
      () => _i19.SignUpFormCubit(get<_i7.IAuthFacade>()));
  gh.factory<_i20.SignUpFormPhoneCubit>(
      () => _i20.SignUpFormPhoneCubit(get<_i3.AuthCubit>()));
  gh.factory<_i21.VerificationCubit>(() => _i21.VerificationCubit(
