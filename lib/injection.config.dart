...
import 'package:telephony/telephony.dart' as _i29;
...
import 'application/auth/sign_up_form/phone/sign_up_form_phone_cubit.dart'
    as _i28;
import 'application/network/network_cubit.dart' as _i20;
import 'application/notification/local_notification_cubit.dart' as _i19;
...
import 'infrastructure/core/app_injectibles.dart' as _i35;
import 'presentation/home/dashboard/cubit/dashboard_cubit.dart' as _i34;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i18.InvestmentCubit>(() => _i18.InvestmentCubit(
      ...
      get<_i8.IAuthFacade>()));
  gh.factory<_i19.LocalNotificationCubit>(() => _i19.LocalNotificationCubit());
  gh.factory<_i20.NetworkCubit>(() => _i20.NetworkCubit());
  gh.factory<_i21.NotificationCubit>(
      () => _i21.NotificationCubit(get<_i12.IFirestoreFacade>()));
  ...
  gh.lazySingleton<_i29.Telephony>(() => firebaseInjectableModule.telephony);
  gh.factory<_i30.VerificationCubit>(() => _i30.VerificationCubit(
      get<_i16.IStorageFacade>(), get<_i12.IFirestoreFacade>()));
  gh.factory<_i31.WalletCubit>(() => _i31.WalletCubit(
      get<_i12.IFirestoreFacade>(), get<_i10.IExternalFacade>()));
  gh.factory<_i32.BankAddressCubit>(
      () => _i32.BankAddressCubit(get<_i12.IFirestoreFacade>()));
  gh.factory<_i33.CryptoWalletCubit>(
      () => _i33.CryptoWalletCubit(get<_i12.IFirestoreFacade>()));
  gh.factory<_i34.DashboardCubit>(() =>
      _i34.DashboardCubit(get<_i16.IStorageFacade>(), get<_i8.IAuthFacade>()));
  return get;
}
