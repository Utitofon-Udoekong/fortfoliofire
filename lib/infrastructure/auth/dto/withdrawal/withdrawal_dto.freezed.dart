...
abstract class $WithdrawalItemDTOCopyWith<$Res> {
  factory $WithdrawalItemDTOCopyWith(
      ...
      _$WithdrawalItemDTOCopyWithImpl<$Res, WithdrawalItemDTO>;
  @useResult
  $Res call(
      {String description,
      double amount,
...
/// @nodoc
class _$WithdrawalItemDTOCopyWithImpl<$Res, $Val extends WithdrawalItemDTO>
...
class __$$_WithdrawalItemDTOCopyWithImpl<$Res>
    extends _$WithdrawalItemDTOCopyWithImpl<$Res, _$_WithdrawalItemDTO>
...
class _$_WithdrawalItemDTO extends _WithdrawalItemDTO {
  ...
  @override
  String toString() {
    return 'WithdrawalItemDTO(description: $description, amount: $amount, duration: $duration, roi: $roi, traxId: $traxId, uid: $uid, status: $status, createdat: $createdat, paymentMethod: $paymentMethod, currency: $currency, refId: $refId, coin: $coin, withdrawalDetails: $withdrawalDetails)';
  }
